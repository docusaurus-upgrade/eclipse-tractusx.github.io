...
The following configuration for the mapping of a Remaining useful Life (RuL) calculation service is written in the [Terse RDF Triple Language](https://www.w3.org/TR/turtle/), also known as *Turtle*.
