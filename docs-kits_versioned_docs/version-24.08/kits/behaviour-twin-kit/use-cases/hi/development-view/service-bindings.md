...
The following configuration for the mapping of a Health Indicator (HI) calculation service is written in the [Terse RDF Triple Language](https://www.w3.org/TR/turtle/), also known as *Turtle*.
...
The property `sh:shapesGraph` contains the graph shape of the offered data, written in [Shapes Constraint Language (SHACL)](https://www.w3.org/TR/shacl/). It describes the shape of a Health Indicator function and its output:
