...
|---|---|---|
|Catena-X|Association, dataspace, automotive network|Open and interoperable data ecosystem of the automotive sector, see [https://catena-x.net/](https://catena-x.net/)|
|Tractus-X|Official open-source project in the Catena-X data space|see [https://eclipse-tractusx.github.io/](https://eclipse-tractusx.github.io/)|
...
|SPARQL|SPARQL 1.1 Query Language|see [SPARQL on w3.org](https://www.w3.org/TR/sparql11-query/)|
|RDF|Resource Description Framework|see [RDF on w3.org](https://www.w3.org/RDF/)|
|ttl (Turtle)|RDF 1.1 Turtle|see [Turtle on w3.org](https://www.w3.org/TR/turtle/)|
|OWL|Web Ontology Language|see [OWL on w3.org](https://www.w3.org/OWL/)|
|SHACL|Shapes Constraint Language|see [SHACL on w3.org](https://www.w3.org/TR/shacl/)|
|W3C|World Wide Web Consortium|see [w3.org](https://www.w3.org/)|
