...
Valid Origin:[Click here](https://business-partners.{env}.demo.catena-x.net/pool/)*

Description: BPDM Pool

BPDM Gate:

Valid Origin: [Click here](https://business-partners{env}.demo.catena-x.net/companies/)*
...
For more details see: [Click here](https://github.com/eclipse-tractusx/sig-release/issues/565/)*
